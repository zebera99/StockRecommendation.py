...
#BAA 카나리아 자산군
canary_universe = {
  'SPY' : SPY_momentum_score, 
  'VEA' : VEA_momentum_score, 
  'VWO' : VWO_momentum_score, 
  'BND' : BND_momentum_score
}
#BAA 공격자산
offensive_universe = {
  'VEA' : VEA_momentum_score, 
  'VWO' : VWO_momentum_score, 
  'BND' : BND_momentum_score,
  'QQQ' : QQQ_momentum_score
}
#BAA 안전 자산
defensive_universe = {
  'TIP' : TIP_12_average_percent,
  'DBC' : DBC_12_average_percent, 
  'BIL' : BIL_12_average_percent, 
  'IEF' : IEF_12_average_percent, 
  'TLT' : TLT_12_average_percent, 
  'LQD' : LQD_12_average_percent, 
  'BND' : BND_12_average_percent
}
#듀얼 모멘텀 안전 자산
...
if biggest == SHY_profit6:
  if biggest < 0:
    count += 1
  else:
    print(f'SHY - {SHY_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("shy",today))} SHY stocks')
elif biggest == IEF_profit6:
  if biggest < 0:
    count += 1
  else:
    print(f'IEF - {IEF_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("ief",today))} IEF stocks')
elif biggest == TLT_profit6:
  if biggest < 0:
    count += 1
  else:
    print(f'TLT - {TLT_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("tlt",today))} TLT stocks')
elif biggest == TIP_profit6:
  if biggest < 0:
    count += 1
  else:
    print(f'TIP - {TIP_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("tip",today))} TIP stocks')
elif biggest == LQD_profit6:
  if biggest < 0:
    count += 1
  else:
    print(f'LQD - {LQD_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("lqd",today))} LQD stocks')
elif biggest == HYG_profit6:
  if biggest < 0:
    count += 1
  else:
    print(f'HYG - {HYG_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("hyg",today))} HYG stocks')
elif biggest == BWX_profit6:
  if biggest < 0:
    count += 1
  else:
    print(f'BWX - {BWX_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("bwx",today))} BWX stocks')
elif biggest == EMB_profit6:
  if biggest < 0:
    count += 1
  else:
    print(f'EMB - {EMB_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("emb",today))} EMB stocks')

if second_biggest == SHY_profit6:
  if second_biggest < 0:
    count += 1
  else:
    print(f'SHY - {SHY_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("shy",today))} SHY stocks')
elif second_biggest == IEF_profit6:
  if second_biggest < 0:
    count += 1
  else:
    print(f'IEF - {IEF_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("ief",today))} IEF stocks')
elif second_biggest == TLT_profit6:
  if second_biggest < 0:
    count += 1
  else:
    print(f'TLT - {TLT_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("tlt",today))} TLT stocks')
elif second_biggest == TIP_profit6:
  if second_biggest < 0:
    count += 1
  else:
    print(f'TIP - {TIP_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("tip",today))} TIP stocks')
elif second_biggest == LQD_profit6:
  if second_biggest < 0:
    count += 1
  else:
    print(f'LQD - {LQD_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("lqd",today))} LQD stocks')
elif second_biggest == HYG_profit6:
  if second_biggest < 0:
    count += 1
  else:
    print(f'HYG - {HYG_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("hyg",today))} HYG stocks')
elif second_biggest == BWX_profit6:
  if second_biggest < 0:
    count += 1
  else:
    print(f'BWX - {BWX_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("bwx",today))} BWX stocks')
elif second_biggest == EMB_profit6:
  if second_biggest < 0:
    count += 1
  else:
    print(f'EMB - {EMB_profit6}')
...
if third_biggest == SHY_profit6:
  if third_biggest < 0:
    count += 1
  else:
    print(f'SHY - {SHY_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("shy",today))} SHY stocks')
elif third_biggest == IEF_profit6:
  if third_biggest < 0:
    count += 1
  else:
    print(f'IEF - {IEF_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("ief",today))} IEF stocks')
elif third_biggest == TLT_profit6:
  if third_biggest < 0:
    count += 1
  else:
    print(f'TLT - {TLT_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("tlt",today))} TLT stocks')
elif third_biggest == TIP_profit6:
  if third_biggest < 0:
    count += 1
  else:
    print(f'TIP - {TIP_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("tip",today))} TIP stocks')
elif third_biggest == LQD_profit6:
  if third_biggest < 0:
    count += 1
  else:
    print(f'LQD - {LQD_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("lqd",today))} LQD stocks')
elif third_biggest == HYG_profit6:
  if third_biggest < 0:
    count += 1
  else:
    print(f'HYG - {HYG_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("hyg",today))} HYG stocks')
elif third_biggest == BWX_profit6:
  if third_biggest < 0:
    count += 1
  else:
    print(f'BWX - {BWX_profit6}')
    print(f'You should buy {int((dual_momentum_money/3) / price("bwx",today))} BWX stocks')
elif third_biggest == EMB_profit6:
  if third_biggest < 0:
    count += 1
  else:
    print(f'EMB - {EMB_profit6}')
